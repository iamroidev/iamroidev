...
Joined AmaliTech hackathon during AWS re/Start; collaborated in a team to build a **SaaS for automating hospital queues** using AWS Lambda, Cognito, DynamoDB, and related services.
